...
- Criamos a classe jogo atrelada a um MonoBehaviour para interagir com o carro, criamos variáveis que comrespondiam aos atributos da classe Player, e uma variável que herdava do Player, chamamos as variáveis para colocarmos valores nelas e atríbuimos cada variálvel para seu atributo comrespondente, no Uptade chamamos os métodos e os atribuímos as variáveis. Criamos uma método para atribuir a tag a string nome e Objeto 3d para atribuir para a variável objeto. Chamando assim o objeto. 
...
- Na classe JogoObstaculo criamos variáveis que atribuímos aos atributos da classe Obstaculo, e variáveis que herdavem da classe Obstaculo, depois atribuímos os valores para cada variável e como elas funcionarão para as variáveis que herdavam da classe Obstaculo, no Uptade chamamos os métodos e os atribuímos as variáveis, e criamos uma método para atribuir a tag a string nome e Objeto 3d para atribuir para a variável objeto. Chamando assim o objeto. 
...
- Cria uma classe feita para tocar a musica em loop durante o jogo
